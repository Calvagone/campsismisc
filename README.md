...
that, we need to create first a dataset.
...
`NcaMetricOutput` and we use any metric from `campsisnca`.
...
<img src="README_files/figure-gfm/fp_metabolism_effect_on_auc -1.png" style="display: block; margin: auto;" />
